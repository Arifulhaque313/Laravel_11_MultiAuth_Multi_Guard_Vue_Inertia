                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('teacher.profile.edit')"> Profile </DropdownLink>
                                        <DropdownLink :href="route('teacher.logout')" method="post" as="button">
                                            Log Out
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('teacher.logout')" method="post" as="button">
                                Log Out
                            </ResponsiveNavLink>
                        </div>
                    </div>
