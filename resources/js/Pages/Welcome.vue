    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        >
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-12 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="col-span-4 flex lg:justify-left lg:col-start-2">
                        <svg
                    ...
                    <nav v-if="canLogin" class="col-span-8 -mx-3 flex flex-1 justify-end">
                        <Link
